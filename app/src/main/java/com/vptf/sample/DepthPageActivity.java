...
public class DepthPageActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_depth_page);
        initView();
        initData();
        initListener();
    }
    ...
    class ViewpagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            View view = LayoutInflater.from(DepthPageActivity.this).inflate(R.layout.view_pager_item, null);
            ...
            itemIV.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(DepthPageActivity.this, position+"", Toast.LENGTH_SHORT).show();
                }
            });
